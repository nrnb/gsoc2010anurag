...
public class LibrarySelectionPanel extends javax.swing.JPanel {
    ...
    private File localDatabaseDir = new File(DatasetParametersPanel.localDatabaseDirectory);
...
//        System.out.println("selected file:" + file.getAbsolutePath());
    ...
    private void initComponents() {
        ...
        jButton7.setToolTipText("Restore default values in the library files field from the selected directory");
