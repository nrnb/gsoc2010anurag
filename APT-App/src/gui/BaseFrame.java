...
//        commandList.add("output-gene");
        ...
        commandList.add("res/celfiles.txt");
        if (algos.size() > 0) {
            commandList.add("-a");
    ...
    private void initComponents() {
        ...
        getContentPane().add(mainPanelParent, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 410, 340));
        ...
        getContentPane().add(nextButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 410, -1, -1));

        jProgressBar1.setStringPainted(true);
        getContentPane().add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 410, 250, 20));
        ...
        getContentPane().add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 410, 80, -1));
        ...
        getContentPane().add(quitButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 410, -1, -1));
...
//                ArrayList<File> libFiles = screen2Panel.getLibraryFiles();
                ...
                //making celfiles.txt
                PrintWriter out = new PrintWriter("res/celfiles.txt");
                ...
                String aptCommand = prop.getProperty("apt");
...
//                            inputReader.start();
                            ...
                            StreamReaderThread errorReader = new StreamReaderThread(commandOutputPanel.getOutputPane(), jProgressBar1, aptProcess.getErrorStream(), datasetPanel.getOutputDirectoryFile().getAbsolutePath());
                            errorReader.start();
...
//                nextButton.setEnabled(true);
    ...
    private void quitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quitButtonActionPerformed
        ...
        } else if (aptProcess != null && !aptProcessRunning) {
            System.exit(0);
        } else if (aptProcess == null) {
