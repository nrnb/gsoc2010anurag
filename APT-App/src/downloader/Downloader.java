...
//                JOptionPane.INFORMATION_MESSAGE);
        ...
        File downloadParentDirectory = new File("download");
        if (!downloadParentDirectory.exists()) {
            downloadParentDirectory.mkdir();
        }

        File tempDirectory = new File("download/" + ID);
...
//        throw new UnsupportedOperationException("Not supported yet.");
        ...
        try {
            ...
            for (int i = 0; i < JET_COUNT; i++) {
                File file = new File("download/" + identifier + "/" + identifier + "part" + i);
            ...
            File tempDirectory = new File("download/" + identifier);
...
//        }
    public static void main(String[] args) throws MalformedURLException, IOException {
        ...
        m.download("http://localhost/celfiles.zip");
